...
import { medicineLabelBuilder } from "@/app/actions/medicineLabelBuilder";
...
export default function Page() {
  ...
  const handleGeneratePDF = async () => {
    ...
    await medicineLabelBuilder(orderId);

    // Trigger the download of the generated PDF
    const link = document.createElement("a");
    link.href = "/documents/completed/medlabel.pdf"; // Adjust the path to your generated PDF
  ...
  return (
    <div style={{ height: "100vh", width: "100%" }}>
      <h1 className="text-2xl font-bold">Download PDF : Medicine Label</h1>
      <p className="text-lg">
